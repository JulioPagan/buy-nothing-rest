...
export class NotesController {
    ...
    @Get()
    viewNotes(@Query() filteredView?: { c_by?: string, v_by?: string, type?: string, agid?: string}, @Query() searchQuery?: { key?: string, start_date?: Date, end_date?: Date}): Note[] | NotesConversation[] {
